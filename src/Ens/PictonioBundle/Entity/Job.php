...
use Ens\PictonioBundle\Utils\Pictonio as Pictonio;
...
class Job {
    ...
    public function getCompanySlug() {
        return Pictonio::slugify($this->getCompany());
    }

    public function getPositionSlug() {
        return Pictonio::slugify($this->getPosition());
    }

    public function getLocationSlug() {
        return Pictonio::slugify($this->getLocation());
    }
